...
@section('script-inicio')
    <script type="text/javascript"  async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDcgRnXLInbYYPxnduPpUY42YFWe8rpig4&libraries=adsense&language=es"></script>
@endsection
@section('content')
                
                <div class="panel-heading">
                    <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-map" aria-hidden="true"></i>&nbsp; Todas las Ubicaciones &nbsp;<i class="fa fa-map" aria-hidden="true"></i></h2>
                </div>
